...
public class LogicTest {
    ...
    public void MoveHandlerTest(){
        ...
        moveHandler.makeMove(new SingleMove(18,18), white);
        ...
        moveHandler.makeMove(new SingleMove(18, 17), black);
        moveHandler.makeMove(new SingleMove(11, 10), white);
        moveHandler.makeMove(new SingleMove(18, 16), black);
        moveHandler.makeMove(new SingleMove(10, 9), white);
        moveHandler.makeMove(new SingleMove(18, 15), black);
        ...
        moveHandler.makeMove(new SingleMove(17, 17), black);
        moveHandler.makeMove(new SingleMove(9, 0), white);
        moveHandler.makeMove(new SingleMove(17, 18), black);
